...
api_key = "SxSBiibE6UQ653F2C4tio1Eh5"
api_secret = "r67juHsZWJHAUJxZDx7mNd92NZUuNYSAqcWCUGAI3lnDFtyAuT"
access_token_key = "783294006369263616-UD5ywNZFuphDNXpZYf6HSWO3yl65hj4"
access_token_secret = "pMHxUWEEiLK4n64bD455xNHPjVE2f7gRpXoxtKp7hX9FU"
...
tweets_num=2500 # number of tweets we want
parameters = []
js=[]
...
#######output tweets file
out = open('tweetsTrump.csv','wb')
print >> out, 'ids, screen_name,location, followers, retweet, inreplyto, favorite, friends, listed, text'

rows = zip(ids, screen_name,location, followers, retweet, inreplyto, favorite, friends, listed, text)
